...
function getActionConfig(t: Translator): Record<string, { label: string; color: string }> {
  return {
    ...
    TWO_FACTOR_ENABLED:            { label: t("membres.activiteView.actions.twoFactorEnabled"),          color: BLUE_L },
    TWO_FACTOR_DISABLED:           { label: t("membres.activiteView.actions.twoFactorDisabled"),         color: SLA    },
    TWO_FACTOR_BACKUP_REGENERATED: { label: t("membres.activiteView.actions.twoFactorBackupRegenerated"), color: SLA   },
    TWO_FACTOR_DISABLED_BY_ADMIN:  { label: t("membres.activiteView.actions.twoFactorDisabledByAdmin"),  color: DEL    },
    LOGIN_SUCCESS:                 { label: t("membres.activiteView.actions.loginSuccess"),              color: SLA    },
    LOGIN_FAILED:                  { label: t("membres.activiteView.actions.loginFailed"),                color: DEL    },
    ...
    PARTICIPANT_ADDED:        { label: t("membres.activiteView.actions.participantAdded"),  color: VIO_L  },
