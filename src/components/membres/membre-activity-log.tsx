...
function getActionConfig(t: Translator): Record<string, { label: string; icon: React.ReactNode; color: string }> {
  return {
    ...
    MEMBRE_ADHESION_COMPLETED: { label: t("membres.activityLog.actions.membreAdhesionCompleted"), icon: <MoneyIcon className="size-3.5" />, color: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300" },
