...
export const POST = withPortalAuth(async (req, ctx) => {
  ...
  const { items, paymentMethod, note, deliveryMethod, shippingAddress, shippingCity, shippingPostalCode, shippingCountry, shippingOptionCode, shippingOptionCostCents } = parsed.data
