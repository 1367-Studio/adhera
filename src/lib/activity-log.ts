...
const MEMBRE_FIELDS = ["firstName", "lastName", "email", "phone", "address", "birthDate", "status", "typeId", "responsableId", "adherentOverride", "notes", "imageRightsConsent", "guardianName", "guardianPhone", "secondGuardianName", "secondGuardianPhone"] as const
